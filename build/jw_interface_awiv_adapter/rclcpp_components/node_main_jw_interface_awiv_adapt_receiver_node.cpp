...
#define NODE_MAIN_LOGGER_NAME "jw_interface_awiv_adapt_receiver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libjw_interface_awiv_adapt_receiver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<JwInterfaceAWIVAdaptReceiver>";
