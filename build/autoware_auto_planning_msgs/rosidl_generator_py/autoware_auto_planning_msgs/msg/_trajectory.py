...
class Metaclass_Trajectory(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'CAPACITY': cls.__constants['CAPACITY'],
        }

    @property
    def CAPACITY(self):
        """Message constant 'CAPACITY'."""
        return Metaclass_Trajectory.__constants['CAPACITY']
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_auto_planning_msgs/TrajectoryPoint, 100>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_planning_msgs', 'msg'], 'TrajectoryPoint'), 100),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'points' field must be a set or sequence with length <= 100 and each value of type 'TrajectoryPoint'"
        self._points = value
