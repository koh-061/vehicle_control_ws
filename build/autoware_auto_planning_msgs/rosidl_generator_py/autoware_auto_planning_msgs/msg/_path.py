...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_auto_planning_msgs/PathPoint>',
        'drivable_area': 'nav_msgs/OccupancyGrid',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_planning_msgs', 'msg'], 'PathPoint')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from nav_msgs.msg import OccupancyGrid
        self.drivable_area = kwargs.get('drivable_area', OccupancyGrid())
    ...
    def __eq__(self, other):
        ...
        if self.points != other.points:
            return False
        if self.drivable_area != other.drivable_area:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'points' field must be a set or sequence and each value of type 'PathPoint'"
        self._points = value

    @builtins.property
    def drivable_area(self):
        """Message field 'drivable_area'."""
        return self._drivable_area

    @drivable_area.setter
    def drivable_area(self, value):
        if __debug__:
            from nav_msgs.msg import OccupancyGrid
            assert \
                isinstance(value, OccupancyGrid), \
                "The 'drivable_area' field must be a sub message of type 'OccupancyGrid'"
        self._drivable_area = value
