...
static rosidl_typesupport_introspection_c__MessageMember autoware_auto_planning_msgs__msg__PathWithLaneId__rosidl_typesupport_introspection_c__PathWithLaneId_message_member_array[3] = {
  {
    "header",  // name
