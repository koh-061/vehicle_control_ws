...
static rosidl_typesupport_introspection_c__MessageMember autoware_auto_planning_msgs__msg__PathPoint__rosidl_typesupport_introspection_c__PathPoint_message_member_array[3] = {
  {
    "pose",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_planning_msgs__msg__PathPoint, twist),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_planning_msgs, msg, PathPoint)() {
  ...
  autoware_auto_planning_msgs__msg__PathPoint__rosidl_typesupport_introspection_c__PathPoint_message_member_array[1].members_ =
