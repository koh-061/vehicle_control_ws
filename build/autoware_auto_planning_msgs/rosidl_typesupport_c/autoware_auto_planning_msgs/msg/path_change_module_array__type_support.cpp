...
#include "autoware_auto_planning_msgs/msg/detail/path_change_module_array__type_support.h"
...
static const _PathChangeModuleArray_type_support_symbol_names_t _PathChangeModuleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_planning_msgs, msg, PathChangeModuleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_planning_msgs, msg, PathChangeModuleArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_planning_msgs, msg, PathChangeModuleArray)() {
  return &::autoware_auto_planning_msgs::msg::rosidl_typesupport_c::PathChangeModuleArray_message_type_support_handle;
}
