...
#include "autoware_auto_planning_msgs/msg/detail/approval__type_support.h"
...
static const _Approval_type_support_symbol_names_t _Approval_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_planning_msgs, msg, Approval)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_planning_msgs, msg, Approval)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_planning_msgs, msg, Approval)() {
  return &::autoware_auto_planning_msgs::msg::rosidl_typesupport_c::Approval_message_type_support_handle;
}
