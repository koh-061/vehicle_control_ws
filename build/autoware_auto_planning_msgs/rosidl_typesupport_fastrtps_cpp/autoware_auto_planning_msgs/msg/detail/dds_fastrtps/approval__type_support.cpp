...
#include "autoware_auto_planning_msgs/msg/detail/approval__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_planning_msgs::msg::Approval & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_planning_msgs::msg::Approval & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_planning_msgs::msg::Approval;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_auto_planning_msgs::msg::Approval *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_planning_msgs::msg::Approval *>(
    untyped_ros_message);
...
static size_t _Approval__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Approval(full_bounded, is_plain, 0);
...
{
  return &autoware_auto_planning_msgs::msg::typesupport_fastrtps_cpp::_Approval__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_planning_msgs, msg, Approval)() {
  return &autoware_auto_planning_msgs::msg::typesupport_fastrtps_cpp::_Approval__handle;
}
