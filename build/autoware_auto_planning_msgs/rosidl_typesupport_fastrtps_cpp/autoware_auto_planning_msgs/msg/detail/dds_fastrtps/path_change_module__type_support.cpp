...
#include "autoware_auto_planning_msgs/msg/detail/path_change_module__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_planning_msgs::msg::PathChangeModule & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_planning_msgs::msg::PathChangeModule & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_planning_msgs::msg::PathChangeModule;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_auto_planning_msgs::msg::PathChangeModule *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_planning_msgs::msg::PathChangeModule *>(
    untyped_ros_message);
...
static size_t _PathChangeModule__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PathChangeModule(full_bounded, is_plain, 0);
...
{
  return &autoware_auto_planning_msgs::msg::typesupport_fastrtps_cpp::_PathChangeModule__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_planning_msgs, msg, PathChangeModule)() {
  return &autoware_auto_planning_msgs::msg::typesupport_fastrtps_cpp::_PathChangeModule__handle;
}
