...
struct Trajectory_
{
  ...
  _header_type header;
  using _points_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>, 100, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>>>;
  _points_type points;
  ...
  Type & set__points(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>, 100, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_planning_msgs::msg::TrajectoryPoint_<ContainerAllocator>>> & _arg)
  {
    this->points = _arg;
    return *this;
  }
