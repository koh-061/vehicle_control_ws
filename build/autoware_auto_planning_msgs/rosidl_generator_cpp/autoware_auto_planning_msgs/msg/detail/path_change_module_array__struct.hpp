...
struct PathChangeModuleArray_
{
  ...
  _header_type header;
  using _modules_type =
    std::vector<autoware_auto_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>>>;
  ...
  Type & set__modules(
    const std::vector<autoware_auto_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_planning_msgs::msg::PathChangeModuleId_<ContainerAllocator>>> & _arg)
  {
    this->modules = _arg;
    return *this;
  }
