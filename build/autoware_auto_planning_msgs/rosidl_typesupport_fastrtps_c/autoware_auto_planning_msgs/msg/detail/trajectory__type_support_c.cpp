...
#include "autoware_auto_planning_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_planning_msgs/msg/detail/trajectory_point__functions.h"  // points
...
using _Trajectory__ros_msg_type = autoware_auto_planning_msgs__msg__Trajectory;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->points);
    }
    if (!autoware_auto_planning_msgs__msg__TrajectoryPoint__Sequence__init(&ros_message->points, size)) {
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_planning_msgs__msg__Trajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_planning_msgs__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_planning_msgs__msg__Trajectory(
