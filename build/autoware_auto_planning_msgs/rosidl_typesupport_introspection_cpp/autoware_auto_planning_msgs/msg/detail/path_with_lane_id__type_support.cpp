...
void fetch_function__PathWithLaneId__points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const autoware_auto_planning_msgs::msg::PathPointWithLaneId *>(
    get_const_function__PathWithLaneId__points(untyped_member, index));
  auto & value = *reinterpret_cast<autoware_auto_planning_msgs::msg::PathPointWithLaneId *>(untyped_value);
  value = item;
}

void assign_function__PathWithLaneId__points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<autoware_auto_planning_msgs::msg::PathPointWithLaneId *>(
    get_function__PathWithLaneId__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const autoware_auto_planning_msgs::msg::PathPointWithLaneId *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathWithLaneId_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__PathWithLaneId__points,  // fetch(index, &value) function pointer
    assign_function__PathWithLaneId__points,  // assign(index, value) function pointer
