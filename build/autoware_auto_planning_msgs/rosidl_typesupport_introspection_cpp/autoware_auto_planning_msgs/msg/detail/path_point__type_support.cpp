...
{
  new (message_memory) autoware_auto_planning_msgs::msg::PathPoint(_init);
}

void PathPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_planning_msgs::msg::PathPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathPoint_message_member_array[3] = {
  {
    ...
    offsetof(autoware_auto_planning_msgs::msg::PathPoint, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_planning_msgs::msg::PathPoint, twist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_planning_msgs::msg::PathPoint, is_final),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathPoint_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_auto_planning_msgs::msg::PathPoint),
...
{
  return &::autoware_auto_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PathPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_planning_msgs, msg, PathPoint)() {
  return &::autoware_auto_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PathPoint_message_type_support_handle;
}
