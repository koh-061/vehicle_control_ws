...
{
  new (message_memory) autoware_auto_planning_msgs::msg::PathChangeModuleId(_init);
}

void PathChangeModuleId_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_planning_msgs::msg::PathChangeModuleId *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathChangeModuleId_message_member_array[1] = {
  {
    ...
    offsetof(autoware_auto_planning_msgs::msg::PathChangeModuleId, type),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathChangeModuleId_message_members = {
  ...
  1,  // number of fields
  sizeof(autoware_auto_planning_msgs::msg::PathChangeModuleId),
...
{
  return &::autoware_auto_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PathChangeModuleId_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_planning_msgs, msg, PathChangeModuleId)() {
  return &::autoware_auto_planning_msgs::msg::rosidl_typesupport_introspection_cpp::PathChangeModuleId_message_type_support_handle;
}
