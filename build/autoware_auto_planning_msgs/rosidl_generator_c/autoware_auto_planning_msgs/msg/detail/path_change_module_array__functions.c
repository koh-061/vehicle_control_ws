...
bool
autoware_auto_planning_msgs__msg__PathChangeModuleArray__are_equal(const autoware_auto_planning_msgs__msg__PathChangeModuleArray * lhs, const autoware_auto_planning_msgs__msg__PathChangeModuleArray * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // modules
  if (!autoware_auto_planning_msgs__msg__PathChangeModuleId__Sequence__are_equal(
...
bool
autoware_auto_planning_msgs__msg__PathChangeModuleArray__copy(
  const autoware_auto_planning_msgs__msg__PathChangeModuleArray * input,
  autoware_auto_planning_msgs__msg__PathChangeModuleArray * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // modules
  if (!autoware_auto_planning_msgs__msg__PathChangeModuleId__Sequence__copy(
...
autoware_auto_planning_msgs__msg__PathChangeModuleArray__create()
{
  ...
  autoware_auto_planning_msgs__msg__PathChangeModuleArray * msg = (autoware_auto_planning_msgs__msg__PathChangeModuleArray *)allocator.allocate(sizeof(autoware_auto_planning_msgs__msg__PathChangeModuleArray), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence__init(autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_planning_msgs__msg__PathChangeModuleArray *)allocator.zero_allocate(size, sizeof(autoware_auto_planning_msgs__msg__PathChangeModuleArray), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence * array = (autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence *)allocator.allocate(sizeof(autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence__are_equal(const autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence * lhs, const autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_planning_msgs__msg__PathChangeModuleArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence__copy(
  const autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence * input,
  autoware_auto_planning_msgs__msg__PathChangeModuleArray__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_planning_msgs__msg__PathChangeModuleArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_auto_planning_msgs__msg__PathChangeModuleArray * data =
      (autoware_auto_planning_msgs__msg__PathChangeModuleArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_planning_msgs__msg__PathChangeModuleArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_planning_msgs__msg__PathChangeModuleArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_planning_msgs__msg__PathChangeModuleArray__copy(
