...
#include "autoware_auto_debug_msgs/msg/detail/multi_array_dimension__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_debug_msgs::msg::MultiArrayDimension;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_auto_debug_msgs::msg::MultiArrayDimension *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_debug_msgs::msg::MultiArrayDimension *>(
    untyped_ros_message);
...
{
  return &autoware_auto_debug_msgs::msg::typesupport_fastrtps_cpp::_MultiArrayDimension__handle;
}
