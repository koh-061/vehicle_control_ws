...
{
  new (message_memory) autoware_auto_debug_msgs::msg::Int32MultiArrayStamped(_init);
}

void Int32MultiArrayStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_auto_debug_msgs::msg::Int32MultiArrayStamped *>(message_memory);
...
void fetch_function__Int32MultiArrayStamped__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__Int32MultiArrayStamped__data(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__Int32MultiArrayStamped__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__Int32MultiArrayStamped__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Int32MultiArrayStamped_message_member_array[3] = {
  {
    ...
    offsetof(autoware_auto_debug_msgs::msg::Int32MultiArrayStamped, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_debug_msgs::msg::Int32MultiArrayStamped, layout),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_debug_msgs::msg::Int32MultiArrayStamped, data),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__Int32MultiArrayStamped__data,  // fetch(index, &value) function pointer
    assign_function__Int32MultiArrayStamped__data,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Int32MultiArrayStamped_message_members = {
  ...
  3,  // number of fields
  sizeof(autoware_auto_debug_msgs::msg::Int32MultiArrayStamped),
...
{
  return &::autoware_auto_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Int32MultiArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_auto_debug_msgs, msg, Int32MultiArrayStamped)() {
  return &::autoware_auto_debug_msgs::msg::rosidl_typesupport_introspection_cpp::Int32MultiArrayStamped_message_type_support_handle;
}
