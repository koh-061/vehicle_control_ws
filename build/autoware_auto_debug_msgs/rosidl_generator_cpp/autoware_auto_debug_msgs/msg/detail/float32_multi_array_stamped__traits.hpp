...
inline void to_yaml(
  const autoware_auto_debug_msgs::msg::Float32MultiArrayStamped & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_auto_debug_msgs::msg::Float32MultiArrayStamped & msg)
{
