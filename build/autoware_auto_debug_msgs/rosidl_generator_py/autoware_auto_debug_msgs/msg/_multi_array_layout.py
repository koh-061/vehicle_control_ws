...
class Metaclass_MultiArrayLayout(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autoware_auto_debug_msgs.msg import MultiArrayDimension
...
class MultiArrayLayout(metaclass=Metaclass_MultiArrayLayout):
    ...
    _fields_and_field_types = {
        'dim': 'sequence<autoware_auto_debug_msgs/MultiArrayDimension>',
        'data_offset': 'uint32',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_debug_msgs', 'msg'], 'MultiArrayDimension')),  # noqa: E501
