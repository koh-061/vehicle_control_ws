...
class Metaclass_Float32MultiArrayStamped(type):
    """Metaclass of message 'Float32MultiArrayStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__float32_multi_array_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__float32_multi_array_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__float32_multi_array_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__float32_multi_array_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__float32_multi_array_stamped
...
class Float32MultiArrayStamped(metaclass=Metaclass_Float32MultiArrayStamped):
    """Message class 'Float32MultiArrayStamped'."""
