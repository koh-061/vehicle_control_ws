...
autoware_auto_debug_msgs__msg__Float32Stamped__create()
{
  ...
  autoware_auto_debug_msgs__msg__Float32Stamped * msg = (autoware_auto_debug_msgs__msg__Float32Stamped *)allocator.allocate(sizeof(autoware_auto_debug_msgs__msg__Float32Stamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Float32Stamped__Sequence__init(autoware_auto_debug_msgs__msg__Float32Stamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__Float32Stamped *)allocator.zero_allocate(size, sizeof(autoware_auto_debug_msgs__msg__Float32Stamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_debug_msgs__msg__Float32Stamped__Sequence * array = (autoware_auto_debug_msgs__msg__Float32Stamped__Sequence *)allocator.allocate(sizeof(autoware_auto_debug_msgs__msg__Float32Stamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Float32Stamped__Sequence__are_equal(const autoware_auto_debug_msgs__msg__Float32Stamped__Sequence * lhs, const autoware_auto_debug_msgs__msg__Float32Stamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_debug_msgs__msg__Float32Stamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_auto_debug_msgs__msg__Float32Stamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_debug_msgs__msg__Float32Stamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_auto_debug_msgs__msg__Float32Stamped * data =
      (autoware_auto_debug_msgs__msg__Float32Stamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_debug_msgs__msg__Float32Stamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_debug_msgs__msg__Float32Stamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_debug_msgs__msg__Float32Stamped__copy(
