...
autoware_auto_debug_msgs__msg__MultiArrayLayout__are_equal(const autoware_auto_debug_msgs__msg__MultiArrayLayout * lhs, const autoware_auto_debug_msgs__msg__MultiArrayLayout * rhs)
{
  ...
  // dim
  if (!autoware_auto_debug_msgs__msg__MultiArrayDimension__Sequence__are_equal(
      &(lhs->dim), &(rhs->dim)))
  {
    return false;
  }
  ...
  autoware_auto_debug_msgs__msg__MultiArrayLayout * output)
{
  ...
  // dim
  if (!autoware_auto_debug_msgs__msg__MultiArrayDimension__Sequence__copy(
...
autoware_auto_debug_msgs__msg__MultiArrayLayout__create()
{
  ...
  autoware_auto_debug_msgs__msg__MultiArrayLayout * msg = (autoware_auto_debug_msgs__msg__MultiArrayLayout *)allocator.allocate(sizeof(autoware_auto_debug_msgs__msg__MultiArrayLayout), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence__init(autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__MultiArrayLayout *)allocator.zero_allocate(size, sizeof(autoware_auto_debug_msgs__msg__MultiArrayLayout), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence * array = (autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence *)allocator.allocate(sizeof(autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence__are_equal(const autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence * lhs, const autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_debug_msgs__msg__MultiArrayLayout__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_auto_debug_msgs__msg__MultiArrayLayout__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_debug_msgs__msg__MultiArrayLayout);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_auto_debug_msgs__msg__MultiArrayLayout * data =
      (autoware_auto_debug_msgs__msg__MultiArrayLayout *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_debug_msgs__msg__MultiArrayLayout__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_debug_msgs__msg__MultiArrayLayout__fini(&output->data[i]);
        }
        return false;
      }
    }
