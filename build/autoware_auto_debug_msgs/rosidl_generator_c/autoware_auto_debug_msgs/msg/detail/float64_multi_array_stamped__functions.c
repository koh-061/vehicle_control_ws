...
autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__create()
{
  ...
  autoware_auto_debug_msgs__msg__Float64MultiArrayStamped * msg = (autoware_auto_debug_msgs__msg__Float64MultiArrayStamped *)allocator.allocate(sizeof(autoware_auto_debug_msgs__msg__Float64MultiArrayStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence__init(autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_debug_msgs__msg__Float64MultiArrayStamped *)allocator.zero_allocate(size, sizeof(autoware_auto_debug_msgs__msg__Float64MultiArrayStamped), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence * array = (autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence *)allocator.allocate(sizeof(autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence__are_equal(const autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence * lhs, const autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_auto_debug_msgs__msg__Float64MultiArrayStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_auto_debug_msgs__msg__Float64MultiArrayStamped * data =
      (autoware_auto_debug_msgs__msg__Float64MultiArrayStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_auto_debug_msgs__msg__Float64MultiArrayStamped__copy(
