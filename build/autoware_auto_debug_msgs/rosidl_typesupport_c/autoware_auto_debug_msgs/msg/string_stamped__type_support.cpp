...
#include "autoware_auto_debug_msgs/msg/detail/string_stamped__type_support.h"
...
static const _StringStamped_type_support_symbol_names_t _StringStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_debug_msgs, msg, StringStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_debug_msgs, msg, StringStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_debug_msgs, msg, StringStamped)() {
  return &::autoware_auto_debug_msgs::msg::rosidl_typesupport_c::StringStamped_message_type_support_handle;
}
