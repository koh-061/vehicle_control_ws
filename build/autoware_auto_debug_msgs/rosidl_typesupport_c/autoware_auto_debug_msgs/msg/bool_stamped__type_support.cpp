...
#include "autoware_auto_debug_msgs/msg/detail/bool_stamped__type_support.h"
...
static const _BoolStamped_type_support_symbol_names_t _BoolStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_debug_msgs, msg, BoolStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_auto_debug_msgs, msg, BoolStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autoware_auto_debug_msgs, msg, BoolStamped)() {
  return &::autoware_auto_debug_msgs::msg::rosidl_typesupport_c::BoolStamped_message_type_support_handle;
}
