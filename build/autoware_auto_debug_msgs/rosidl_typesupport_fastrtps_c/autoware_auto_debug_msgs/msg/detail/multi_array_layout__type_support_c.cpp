...
#include "autoware_auto_debug_msgs/msg/detail/multi_array_layout__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_debug_msgs/msg/detail/multi_array_dimension__functions.h"  // dim

// forward declare type support functions
size_t get_serialized_size_autoware_auto_debug_msgs__msg__MultiArrayDimension(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_autoware_auto_debug_msgs__msg__MultiArrayDimension(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_debug_msgs, msg, MultiArrayDimension)();


using _MultiArrayLayout__ros_msg_type = autoware_auto_debug_msgs__msg__MultiArrayLayout;
  ...
  // Field name: dim
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_debug_msgs, msg, MultiArrayDimension
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: dim
  {
    ...
    if (ros_message->dim.data) {
      autoware_auto_debug_msgs__msg__MultiArrayDimension__Sequence__fini(&ros_message->dim);
    }
    if (!autoware_auto_debug_msgs__msg__MultiArrayDimension__Sequence__init(&ros_message->dim, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_autoware_auto_debug_msgs__msg__MultiArrayDimension(
...
static uint32_t _MultiArrayLayout__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_debug_msgs__msg__MultiArrayLayout(
  ...
  size_t current_alignment)
{
  ...
  // member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_autoware_auto_debug_msgs__msg__MultiArrayDimension(
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_debug_msgs__msg__MultiArrayLayout;
    is_plain =
      (
...
static size_t _MultiArrayLayout__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_debug_msgs__msg__MultiArrayLayout(
