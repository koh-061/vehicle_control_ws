...
#include "autoware_auto_debug_msgs/msg/detail/int64_multi_array_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _Int64MultiArrayStamped__ros_msg_type = autoware_auto_debug_msgs__msg__Int64MultiArrayStamped;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Int64MultiArrayStamped__ros_msg_type * ros_message = static_cast<const _Int64MultiArrayStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Int64MultiArrayStamped__ros_msg_type * ros_message = static_cast<_Int64MultiArrayStamped__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_autoware_auto_debug_msgs__msg__Int64MultiArrayStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Int64MultiArrayStamped__ros_msg_type * ros_message = static_cast<const _Int64MultiArrayStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Int64MultiArrayStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_debug_msgs__msg__Int64MultiArrayStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_debug_msgs
size_t max_serialized_size_autoware_auto_debug_msgs__msg__Int64MultiArrayStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_debug_msgs__msg__Int64MultiArrayStamped;
    is_plain =
      (
...
static size_t _Int64MultiArrayStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_autoware_auto_debug_msgs__msg__Int64MultiArrayStamped(
...
static message_type_support_callbacks_t __callbacks_Int64MultiArrayStamped = {
...
static rosidl_message_type_support_t _Int64MultiArrayStamped__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Int64MultiArrayStamped,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_debug_msgs, msg, Int64MultiArrayStamped)() {
  return &_Int64MultiArrayStamped__type_support;
}
