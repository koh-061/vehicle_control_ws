...
autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__create()
{
  ...
  autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic * msg = (autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic *)allocator.allocate(sizeof(autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__Sequence__init(autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic *)allocator.zero_allocate(size, sizeof(autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__Sequence * array = (autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__Sequence *)allocator.allocate(sizeof(autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic * data =
      (autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_auto_system_msgs__msg__Float32MultiArrayDiagnostic__fini(&output->data[i]);
        }
        return false;
      }
    }
