...
{
  ///  Convenience value, calculated from the shape. If there are several shapes, this refers to the first one.
  geometry_msgs__msg__Point centroid_position;
  ///  Position covariance is always provided by tracking.
