...
enum
{
  autoware_auto_perception_msgs__msg__PredictedObjectKinematics__predicted_paths__MAX_SIZE = 10
};
...
{
  geometry_msgs__msg__PoseWithCovariance initial_pose;
  geometry_msgs__msg__TwistWithCovariance initial_twist;
  geometry_msgs__msg__AccelWithCovariance initial_acceleration;
