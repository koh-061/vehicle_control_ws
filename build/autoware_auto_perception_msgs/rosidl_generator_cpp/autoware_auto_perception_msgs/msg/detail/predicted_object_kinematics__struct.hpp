...
struct PredictedObjectKinematics_
{
  ...
  : initial_pose(_alloc, _init),
    initial_twist(_alloc, _init),
    initial_acceleration(_alloc, _init)
  {
    (void)_init;
  }
  ...
  using _initial_twist_type =
    geometry_msgs::msg::TwistWithCovariance_<ContainerAllocator>;
  _initial_twist_type initial_twist;
  using _initial_acceleration_type =
    geometry_msgs::msg::AccelWithCovariance_<ContainerAllocator>;
  _initial_acceleration_type initial_acceleration;
  using _predicted_paths_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>, 10, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>>>;
  ...
  Type & set__initial_twist(
    const geometry_msgs::msg::TwistWithCovariance_<ContainerAllocator> & _arg)
  {
    this->initial_twist = _arg;
    return *this;
  }
  Type & set__initial_acceleration(
    const geometry_msgs::msg::AccelWithCovariance_<ContainerAllocator> & _arg)
  {
    this->initial_acceleration = _arg;
    return *this;
  }
  Type & set__predicted_paths(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>, 10, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_perception_msgs::msg::PredictedPath_<ContainerAllocator>>> & _arg)
  {
  ...
  bool operator==(const PredictedObjectKinematics_ & other) const
  {
    ...
    if (this->initial_twist != other.initial_twist) {
      return false;
    }
    if (this->initial_acceleration != other.initial_acceleration) {
      return false;
    }
