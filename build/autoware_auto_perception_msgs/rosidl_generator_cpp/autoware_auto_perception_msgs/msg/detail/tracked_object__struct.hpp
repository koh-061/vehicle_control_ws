...
struct TrackedObject_
{
  ...
  using _shape_type =
    rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::Shape_<ContainerAllocator>, 5, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_perception_msgs::msg::Shape_<ContainerAllocator>>>;
  _shape_type shape;
  ...
  Type & set__shape(
    const rosidl_runtime_cpp::BoundedVector<autoware_auto_perception_msgs::msg::Shape_<ContainerAllocator>, 5, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<autoware_auto_perception_msgs::msg::Shape_<ContainerAllocator>>> & _arg)
  {
    this->shape = _arg;
    return *this;
  }
