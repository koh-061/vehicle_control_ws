...
{
public:
  explicit Init_TrackedObject_object_id(::autoware_auto_perception_msgs::msg::TrackedObject & msg)
  : msg_(msg)
  {}
...
public:
  ...
  {}
  Init_TrackedObject_object_id uuid(::autoware_auto_perception_msgs::msg::TrackedObject::_uuid_type arg)
  {
...
{
  return autoware_auto_perception_msgs::msg::builder::Init_TrackedObject_uuid();
}
