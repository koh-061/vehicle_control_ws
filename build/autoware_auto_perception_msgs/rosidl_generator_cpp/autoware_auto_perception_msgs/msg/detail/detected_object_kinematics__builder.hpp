...
class Init_DetectedObjectKinematics_twist
{
public:
  explicit Init_DetectedObjectKinematics_twist(::autoware_auto_perception_msgs::msg::DetectedObjectKinematics & msg)
  : msg_(msg)
  {}
  Init_DetectedObjectKinematics_has_twist twist(::autoware_auto_perception_msgs::msg::DetectedObjectKinematics::_twist_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_DetectedObjectKinematics_twist orientation_availability(::autoware_auto_perception_msgs::msg::DetectedObjectKinematics::_orientation_availability_type arg)
  {
    msg_.orientation_availability = std::move(arg);
    return Init_DetectedObjectKinematics_twist(msg_);
  }
