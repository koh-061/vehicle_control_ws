  ...
  std::ostream & out)
{
  ...
  {
    out << "initial_twist: ";
    to_flow_style_yaml(msg.initial_twist, out);
    out << ", ";
  }

  // member: initial_acceleration
  {
    out << "initial_acceleration: ";
    to_flow_style_yaml(msg.initial_acceleration, out);
    out << ", ";
  }
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: initial_twist
  {
    ...
    out << "initial_twist:\n";
    to_block_style_yaml(msg.initial_twist, out, indentation + 2);
  }
  ...
  // member: initial_acceleration
  {
    ...
    out << "initial_acceleration:\n";
    to_block_style_yaml(msg.initial_acceleration, out, indentation + 2);
  }
