...
{
public:
  explicit Init_PredictedObject_object_id(::autoware_auto_perception_msgs::msg::PredictedObject & msg)
  : msg_(msg)
  {}
...
class Init_PredictedObject_uuid
{
public:
  Init_PredictedObject_uuid()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_PredictedObject_object_id uuid(::autoware_auto_perception_msgs::msg::PredictedObject::_uuid_type arg)
  {
    msg_.uuid = std::move(arg);
    return Init_PredictedObject_object_id(msg_);
  }
...
{
  return autoware_auto_perception_msgs::msg::builder::Init_PredictedObject_uuid();
}
