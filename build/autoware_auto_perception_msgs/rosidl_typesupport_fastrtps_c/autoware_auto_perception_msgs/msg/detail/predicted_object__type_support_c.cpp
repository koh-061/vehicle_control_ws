...
#include "autoware_auto_perception_msgs/msg/detail/predicted_object__rosidl_typesupport_fastrtps_c.h"
...
#include "autoware_auto_perception_msgs/msg/detail/predicted_object_kinematics__functions.h"  // kinematics
...
using _PredictedObject__ros_msg_type = autoware_auto_perception_msgs__msg__PredictedObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: kinematics
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, autoware_auto_perception_msgs, msg, PredictedObjectKinematics
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: shape
  {
    ...
    if (ros_message->shape.data) {
      autoware_auto_perception_msgs__msg__Shape__Sequence__fini(&ros_message->shape);
    }
    if (!autoware_auto_perception_msgs__msg__Shape__Sequence__init(&ros_message->shape, size)) {
...
size_t get_serialized_size_autoware_auto_perception_msgs__msg__PredictedObject(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PredictedObject__ros_msg_type * ros_message = static_cast<const _PredictedObject__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_autoware_auto_perception_msgs__msg__PredictedObjectKinematics(
...
static uint32_t _PredictedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_auto_perception_msgs__msg__PredictedObject(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_auto_perception_msgs
size_t max_serialized_size_autoware_auto_perception_msgs__msg__PredictedObject(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _PredictedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_auto_perception_msgs__msg__PredictedObject(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_auto_perception_msgs, msg, PredictedObject)() {
