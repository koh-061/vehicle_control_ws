...
#include "autoware_auto_perception_msgs/msg/detail/object_classification__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::ObjectClassification & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::ObjectClassification & ros_message)
{
  // Member: classification
  cdr >> ros_message.classification;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_perception_msgs::msg::ObjectClassification;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::ObjectClassification *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::ObjectClassification *>(
    untyped_ros_message);
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectClassification__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, ObjectClassification)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_ObjectClassification__handle;
}
