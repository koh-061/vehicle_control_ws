...
#include "autoware_auto_perception_msgs/msg/detail/predicted_object_kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_auto_perception_msgs::msg::PredictedPath &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_auto_perception_msgs::msg::PredictedObjectKinematics & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.initial_twist,
    cdr);
  // Member: initial_acceleration
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.initial_acceleration,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_auto_perception_msgs::msg::PredictedObjectKinematics & ros_message)
{
  // Member: initial_pose
  ...
  size_t current_alignment)
{
  ...
  // Member: predicted_paths
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PredictedPath(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_auto_perception_msgs::msg::PredictedObjectKinematics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_auto_perception_msgs::msg::PredictedObjectKinematics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_auto_perception_msgs::msg::PredictedObjectKinematics *>(
    untyped_ros_message);
...
static size_t _PredictedObjectKinematics__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PredictedObjectKinematics(full_bounded, is_plain, 0);
...
{
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_PredictedObjectKinematics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_auto_perception_msgs, msg, PredictedObjectKinematics)() {
  return &autoware_auto_perception_msgs::msg::typesupport_fastrtps_cpp::_PredictedObjectKinematics__handle;
}
