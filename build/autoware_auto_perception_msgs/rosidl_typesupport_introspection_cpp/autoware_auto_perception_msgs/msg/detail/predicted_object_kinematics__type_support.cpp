...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PredictedObjectKinematics_message_member_array[4] = {
  {
    ...
    offsetof(autoware_auto_perception_msgs::msg::PredictedObjectKinematics, initial_pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_perception_msgs::msg::PredictedObjectKinematics, initial_twist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_auto_perception_msgs::msg::PredictedObjectKinematics, initial_acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
