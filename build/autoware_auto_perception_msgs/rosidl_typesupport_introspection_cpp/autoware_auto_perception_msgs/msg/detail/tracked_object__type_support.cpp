...
size_t size_function__TrackedObject__shape(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_auto_perception_msgs::msg::Shape> *>(untyped_member);
  return member->size();
}

const void * get_const_function__TrackedObject__shape(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__TrackedObject__shape(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrackedObject_message_member_array[6] = {
  {
    "uuid",  // name
    ...
    offsetof(autoware_auto_perception_msgs::msg::TrackedObject, uuid),  // bytes offset in struct
  ...
  },
  {
    ...
    nullptr,  // default value
    size_function__TrackedObject__shape,  // size() function pointer
    get_const_function__TrackedObject__shape,  // get_const(index) function pointer
    get_function__TrackedObject__shape,  // get(index) function pointer
    fetch_function__TrackedObject__shape,  // fetch(index, &value) function pointer
    assign_function__TrackedObject__shape,  // assign(index, value) function pointer
    resize_function__TrackedObject__shape  // resize(index) function pointer
  }
};
