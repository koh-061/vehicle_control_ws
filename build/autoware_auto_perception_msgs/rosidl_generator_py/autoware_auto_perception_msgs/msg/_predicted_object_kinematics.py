...
class PredictedObjectKinematics(metaclass=Metaclass_PredictedObjectKinematics):
    ...
    __slots__ = [
        '_initial_pose',
        '_initial_twist',
        '_initial_acceleration',
        '_predicted_paths',
    ]

    _fields_and_field_types = {
        'initial_pose': 'geometry_msgs/PoseWithCovariance',
        'initial_twist': 'geometry_msgs/TwistWithCovariance',
        'initial_acceleration': 'geometry_msgs/AccelWithCovariance',
        'predicted_paths': 'sequence<autoware_auto_perception_msgs/PredictedPath, 10>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autoware_auto_perception_msgs', 'msg'], 'PredictedPath'), 10),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import PoseWithCovariance
        self.initial_pose = kwargs.get('initial_pose', PoseWithCovariance())
        from geometry_msgs.msg import TwistWithCovariance
        self.initial_twist = kwargs.get('initial_twist', TwistWithCovariance())
        from geometry_msgs.msg import AccelWithCovariance
        self.initial_acceleration = kwargs.get('initial_acceleration', AccelWithCovariance())
    ...
    def __eq__(self, other):
        ...
        if self.initial_pose != other.initial_pose:
            return False
        if self.initial_twist != other.initial_twist:
            return False
        if self.initial_acceleration != other.initial_acceleration:
            return False
    ...
    def initial_pose(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'initial_pose' field must be a sub message of type 'PoseWithCovariance'"
        self._initial_pose = value

    @builtins.property
    def initial_twist(self):
        """Message field 'initial_twist'."""
        return self._initial_twist

    @initial_twist.setter
    def initial_twist(self, value):
        if __debug__:
            from geometry_msgs.msg import TwistWithCovariance
            assert \
                isinstance(value, TwistWithCovariance), \
                "The 'initial_twist' field must be a sub message of type 'TwistWithCovariance'"
        self._initial_twist = value

    @builtins.property
    def initial_acceleration(self):
        """Message field 'initial_acceleration'."""
        return self._initial_acceleration

    @initial_acceleration.setter
    def initial_acceleration(self, value):
        if __debug__:
            from geometry_msgs.msg import AccelWithCovariance
            assert \
                isinstance(value, AccelWithCovariance), \
                "The 'initial_acceleration' field must be a sub message of type 'AccelWithCovariance'"
        self._initial_acceleration = value
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'predicted_paths' field must be a set or sequence with length <= 10 and each value of type 'PredictedPath'"
