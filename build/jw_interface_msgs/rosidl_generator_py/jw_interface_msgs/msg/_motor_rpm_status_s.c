...
bool jw_interface_msgs__msg__motor_rpm_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("jw_interface_msgs.msg._motor_rpm_status.MotorRPMStatus", full_classname_dest, 54) == 0);
  }
  jw_interface_msgs__msg__MotorRPMStatus * ros_message = _ros_message;
  {  // left_rpm
...
{
  /* NOTE(esteve): Call constructor of MotorRPMStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("jw_interface_msgs.msg._motor_rpm_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorRPMStatus");
