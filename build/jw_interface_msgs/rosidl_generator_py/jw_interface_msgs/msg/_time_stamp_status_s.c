...
bool jw_interface_msgs__msg__time_stamp_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("jw_interface_msgs.msg._time_stamp_status.TimeStampStatus", full_classname_dest, 56) == 0);
  }
  jw_interface_msgs__msg__TimeStampStatus * ros_message = _ros_message;
  {  // time_stamp
...
{
  /* NOTE(esteve): Call constructor of TimeStampStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("jw_interface_msgs.msg._time_stamp_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TimeStampStatus");
