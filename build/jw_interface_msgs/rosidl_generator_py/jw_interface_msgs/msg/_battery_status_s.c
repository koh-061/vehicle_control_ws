...
bool jw_interface_msgs__msg__battery_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("jw_interface_msgs.msg._battery_status.BatteryStatus", full_classname_dest, 51) == 0);
  }
  jw_interface_msgs__msg__BatteryStatus * ros_message = _ros_message;
  {  // charge
  ...
  {  // amperage
    ...
    assert(PyFloat_Check(field));
    ros_message->amperage = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * jw_interface_msgs__msg__battery_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("jw_interface_msgs.msg._battery_status");
  ...
  {  // amperage
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->amperage);
    {
