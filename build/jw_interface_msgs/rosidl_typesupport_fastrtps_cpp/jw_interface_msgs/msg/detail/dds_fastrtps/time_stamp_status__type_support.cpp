...
#include "jw_interface_msgs/msg/detail/time_stamp_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jw_interface_msgs::msg::TimeStampStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const jw_interface_msgs::msg::TimeStampStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<jw_interface_msgs::msg::TimeStampStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TimeStampStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const jw_interface_msgs::msg::TimeStampStatus *>(
...
static size_t _TimeStampStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TimeStampStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TimeStampStatus__callbacks = {
...
static rosidl_message_type_support_t _TimeStampStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TimeStampStatus__callbacks,
...
{
  return &jw_interface_msgs::msg::typesupport_fastrtps_cpp::_TimeStampStatus__handle;
}
