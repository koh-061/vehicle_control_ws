...
#include "jw_interface_msgs/msg/detail/jsad_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const jw_interface_msgs::msg::JSADCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  jw_interface_msgs::msg::JSADCommand & ros_message)
{
  // Member: front_back_ratio
  cdr >> ros_message.front_back_ratio;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jw_interface_msgs::msg::JSADCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const jw_interface_msgs::msg::JSADCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<jw_interface_msgs::msg::JSADCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _JSADCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const jw_interface_msgs::msg::JSADCommand *>(
...
static size_t _JSADCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_JSADCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _JSADCommand__callbacks = {
...
static rosidl_message_type_support_t _JSADCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_JSADCommand__callbacks,
...
{
  return &jw_interface_msgs::msg::typesupport_fastrtps_cpp::_JSADCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, jw_interface_msgs, msg, JSADCommand)() {
  return &jw_interface_msgs::msg::typesupport_fastrtps_cpp::_JSADCommand__handle;
}
