...
#include "jw_interface_msgs/msg/detail/speed_setting_status__rosidl_typesupport_fastrtps_c.h"
...
using _SpeedSettingStatus__ros_msg_type = jw_interface_msgs__msg__SpeedSettingStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SpeedSettingStatus__ros_msg_type * ros_message = static_cast<const _SpeedSettingStatus__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _SpeedSettingStatus__ros_msg_type * ros_message = static_cast<_SpeedSettingStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: speed_setting
  {
    cdr >> ros_message->speed_setting;
  }
...
static uint32_t _SpeedSettingStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jw_interface_msgs__msg__SpeedSettingStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jw_interface_msgs__msg__SpeedSettingStatus;
    is_plain =
      (
...
static size_t _SpeedSettingStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jw_interface_msgs__msg__SpeedSettingStatus(
...
static message_type_support_callbacks_t __callbacks_SpeedSettingStatus = {
...
static rosidl_message_type_support_t _SpeedSettingStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SpeedSettingStatus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jw_interface_msgs, msg, SpeedSettingStatus)() {
  return &_SpeedSettingStatus__type_support;
}
