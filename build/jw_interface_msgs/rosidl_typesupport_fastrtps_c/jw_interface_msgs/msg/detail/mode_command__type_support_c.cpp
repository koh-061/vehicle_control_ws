...
#include "jw_interface_msgs/msg/detail/mode_command__rosidl_typesupport_fastrtps_c.h"
...
using _ModeCommand__ros_msg_type = jw_interface_msgs__msg__ModeCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ModeCommand__ros_msg_type * ros_message = static_cast<const _ModeCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ModeCommand__ros_msg_type * ros_message = static_cast<_ModeCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
    cdr >> ros_message->mode;
  }
...
static uint32_t _ModeCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jw_interface_msgs__msg__ModeCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jw_interface_msgs__msg__ModeCommand;
    is_plain =
      (
...
static size_t _ModeCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jw_interface_msgs__msg__ModeCommand(
...
static message_type_support_callbacks_t __callbacks_ModeCommand = {
...
static rosidl_message_type_support_t _ModeCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ModeCommand,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jw_interface_msgs, msg, ModeCommand)() {
  return &_ModeCommand__type_support;
}
