...
#include "jw_interface_msgs/msg/detail/motor_rpm_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotorRPMCommand__ros_msg_type = jw_interface_msgs__msg__MotorRPMCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorRPMCommand__ros_msg_type * ros_message = static_cast<const _MotorRPMCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: left_rpm
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MotorRPMCommand__ros_msg_type * ros_message = static_cast<_MotorRPMCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: left_rpm
  {
    cdr >> ros_message->left_rpm;
  }
...
static uint32_t _MotorRPMCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jw_interface_msgs__msg__MotorRPMCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jw_interface_msgs__msg__MotorRPMCommand;
    is_plain =
      (
...
static size_t _MotorRPMCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jw_interface_msgs__msg__MotorRPMCommand(
...
static message_type_support_callbacks_t __callbacks_MotorRPMCommand = {
...
static rosidl_message_type_support_t _MotorRPMCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorRPMCommand,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jw_interface_msgs, msg, MotorRPMCommand)() {
  return &_MotorRPMCommand__type_support;
}
