...
#include "jw_interface_msgs/msg/detail/jsad_status__rosidl_typesupport_fastrtps_c.h"
...
using _JSADStatus__ros_msg_type = jw_interface_msgs__msg__JSADStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JSADStatus__ros_msg_type * ros_message = static_cast<const _JSADStatus__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _JSADStatus__ros_msg_type * ros_message = static_cast<_JSADStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: front_back_ratio
  {
    cdr >> ros_message->front_back_ratio;
  }
...
static uint32_t _JSADStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_jw_interface_msgs__msg__JSADStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = jw_interface_msgs__msg__JSADStatus;
    is_plain =
      (
...
static size_t _JSADStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_jw_interface_msgs__msg__JSADStatus(
...
static message_type_support_callbacks_t __callbacks_JSADStatus = {
...
static rosidl_message_type_support_t _JSADStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JSADStatus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, jw_interface_msgs, msg, JSADStatus)() {
  return &_JSADStatus__type_support;
}
